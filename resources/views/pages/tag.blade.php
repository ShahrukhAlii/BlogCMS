    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h2><i class="fa fa-star bg-orange"></i> {{$tag->name}} <small class="hidden-xs-down hidden-sm-down"> </small></h2>
            </div><!-- end col -->
                      ...
                      @foreach($tag->post as $p)
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                ...
                                <small class="firstsmall"><a class="bg-orange" href="{{route('page.single',$tag->id)}}" title="">{{$tag->name}}</a></small>
